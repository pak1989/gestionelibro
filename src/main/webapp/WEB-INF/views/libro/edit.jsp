	   ...
	   <%@ include file="../header.jsp" %>
	    ...
	    <div class="page-header">
		  <h3>Pagina di Modifica</h3>
			...
			<form:form class="form-horizontal" action="update" method="post" commandName="libroCommand">
				<form:hidden path="id"/>
  			...
  			<div class="form-group">
      			<label class="control-label col-sm-2" for="cognomeId">Genere:</label>
	    		<div class="col-sm-4">
			...
			<div class="form-group">
	    		...
	    		<div class="col-sm-4">
			        <form:select path="autore.id" multiple="false">
